export const LEASE_ENDPOINT = {
  ...
  createDocument: `${process.env.NEXT_PUBLIC_APP_API}/leases/create-lease-document`,
  removeDocument: `${process.env.NEXT_PUBLIC_APP_API}/leases/remove-lease-document`,
};
