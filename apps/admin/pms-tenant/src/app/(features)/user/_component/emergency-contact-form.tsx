...
import { EmergencyContact, UserContactType } from "@/app/models/emergency-contact.model";
...
export default function EmergencyContactForm(props: Props) {
  ...
  const [createEmergencyContact, { isLoading: creating, isSuccess: created }] =
    useCreateEmergencyContactMutation();
  const [updateEmergencyContact, { isLoading: updating }] = useUpdateEmergencyContactMutation();
      ...
      {props?.editMode !== "view" ? (
              ...
              <Box className="px-2 w-full mt-4 flex-col space-y-4">
                ...
                <Flex gap={8}>
                  ...
                  <Select
                    ...
                    onChange={(value) => setValue("contactType", value as UserContactType)}
                    data={[
        ...
        <Box className="w-full">
          <tr className="flex border-t border-b border-dashed">
            ...
            <td className="p-2">{props?.data?.firstName} {props?.data?.middleName} {props?.data?.lastName}</td>
          </tr>
